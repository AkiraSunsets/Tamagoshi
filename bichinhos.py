...
class Hamster(Tamagoshi):
    def __init__(self, nome):
        super().__init__(nome)
        self.energia_rodar = 100   # antes era self.rodar
        self.nivel_fofura = True   # antes era self.fofura
...
class Cachorro(Tamagoshi):
    def __init__(self, nome):
        super().__init__(nome)
        self.nivel_lealdade = 50   # antes era self.lealdade
        self.energia_corrida = 100 # antes era self.energia
